...
A single page app with a calculator and random phrase generator functionalities.
...
- Random phrase generator functionality
...
```bash
git clone https://github.com/maov19/math-magicians/
```
...
[Kindly raise issue here](https://github.com/maov19/math-magicians/issues)
